...
class MyHashMap:
    ...
    def __put(self, key: int, value: int, resize: bool) -> None:
        ...
        while self.keys[hash_value] not in [None, 'Deleted']:
    ...
    def key_exists(self, key: int) -> Union[int, None]:
        ...
        while self.keys[current_hash_value] is not None:
            ...
            current_hash_value = self.rehash_function(current_hash_value) # Computing the new hash value
    ...
    def rehash_function(self, hash_value: int) -> int:
